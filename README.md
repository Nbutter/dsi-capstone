...
## Part 2 - notebook
[Notebook with description of project selection and preliminary EDA](./part_02/Capstone_Butterworth_part_02_Summary_EDA.ipynb)

[Notebook with time series visualizations](./part_02/Time-Series-Visualizations.ipynb)

[Notebook creating sparse matrix from dataframe (40MM rows x 29K features)](./part_03/Capstone_Butterworth_part_03_Saving_Sparse_Matrix.ipynb)
****
